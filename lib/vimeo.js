  ...
  return function (res) {
    ...
    if (res.statusCode >= 400) {
      ...
      res.on('end', function () {
        ...
        reject === undefined ? callback(err, buffer, res.statusCode, res.headers) : reject(err)
      })
    } else {
      ...
      res.on('end', function () {
        try {
          ...
          return reject === undefined ? callback(e, buffer, res.statusCode, res.headers) : reject(e)
        }
