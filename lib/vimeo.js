 ...
 * @param  {boolean} store_access_token If true, updates the current Vimeo instance and stores the access token in case of a valid response (Optional)
 ...
 * @return {[type]}
 */
Vimeo.prototype.accessToken = function (code, redirect_uri, store_access_token, fn) {
	var _self = this;
  ...
  if (typeof fb === 'undefined') {
	...
	this.request({
      ...
      if (store_access_token) _self.access_token = body.access_token;
 ...
 */
Vimeo.prototype.generateClientCredentials = function (scope, store_access_token, fn) {
  var _self = this;
 ...
 */
Vimeo.prototype.streamingUpload = function (path, headers, callback) {
    var _self = this;
